                   ...
                   <a href="{{$app->url}}" class="gap-6">
                       ...
                       <div class="flex justify-between my-3">
                           @foreach($app->platforms as $platform)
                               <img class="text-gray-400" src="{{'/vendor/blade-heroicons/m-' . $platform->slug . '.svg'}}" width="22" alt="{{$platform->name}}"/>
